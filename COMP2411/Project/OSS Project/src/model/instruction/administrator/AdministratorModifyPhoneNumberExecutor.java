...
public class AdministratorModifyPhoneNumberExecutor implements InstructionExecutor {
    private String phoneNumber;
    private String newPhoneNumber;

    public AdministratorModifyPhoneNumberExecutor(String phoneNumber) {
    ...
    public void executeInstruction() throws SQLException {
        ...
        if (confirmationScanner.getInput().trim().equals("Y")) {
            ...
            AdministratorPanelExecutor administratorPanelExecutor = new AdministratorPanelExecutor(this.newPhoneNumber);
    ...
    public void visitDatabase() throws SQLException {
        String sql;
        sql = "UPDATE ADMIN SET " + "PHONE_NUMBER" + " = '" + this.newPhoneNumber + "' WHERE PHONE_NUMBER = '" + this.phoneNumber + "'";

...
public class AdministratorFilterCategoryExecutor implements InstructionExecutor {

    private String phoneNumber;
    private String keyword;

    public AdministratorFilterCategoryExecutor(String phoneNumber) {
    ...
    public void information() throws SQLException {
        System.out.println("*********************************************************************************");
        System.out.println("You are now filtering with a keyword on the product category");
        System.out.println();
    ...
    public void visitDatabase() throws SQLException {
        ...
        String sss = "SELECT p.PRODUCT_ID, p.PRODUCT_NAME, p.DESCRIPTION, p.SPECIFICATION, p.PRICE, p.AVAILABLE_QUANTITY, p.CATEGORY, r.CONTENT " +
                ...
                "WHERE p.CATEGORY LIKE '%" + this.keyword + "%'";
        String sql = "SELECT * FROM PRODUCT WHERE CATEGORY LIKE '%" + this.keyword + "%'";

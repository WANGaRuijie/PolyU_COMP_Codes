...
public class AdministratorSearchCustomerOnPhoneNumberExecutor implements InstructionExecutor {

    private String phoneNumber;

    private String customerPhoneNumber;

    public AdministratorSearchCustomerOnPhoneNumberExecutor(String phoneNumber) {
    ...
    public void information() throws SQLException {
        System.out.println("*********************************************************************************");
        System.out.println("You are now searching a customer according to customer phone number");
        System.out.println();
    ...
    public void executeInstruction() throws SQLException {
        information();
        System.out.print("Please enter the phone number of the customer to search: ");
    ...
    public void visitDatabase() throws SQLException {
        ...
        String sql = "SELECT * FROM CUSTOMER WHERE PHONE_NUMBER = '" + this.customerPhoneNumber + "'";

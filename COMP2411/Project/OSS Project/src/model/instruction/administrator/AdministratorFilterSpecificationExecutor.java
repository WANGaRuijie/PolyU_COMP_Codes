...
public class AdministratorFilterSpecificationExecutor implements InstructionExecutor {

    private String phoneNumber;
    private String keyword;

    public AdministratorFilterSpecificationExecutor(String phoneNumber) {
    ...
    public void information() throws SQLException {
        System.out.println("*********************************************************************************");
        System.out.println("You are now filtering with a keyword on the product specification");
        System.out.println();
    ...
    public void visitDatabase() throws SQLException {
        ...
        String sss = "SELECT p.PRODUCT_ID, p.PRODUCT_NAME, p.DESCRIPTION, p.SPECIFICATION, p.PRICE, p.AVAILABLE_QUANTITY, p.CATEGORY, r.CONTENT " +
                ...
                "WHERE p.SPECIFICATION LIKE '%" + this.keyword + "%'";
        String sql = "SELECT * FROM PRODUCT WHERE SPECIFICATION LIKE '%" + this.keyword + "%'";

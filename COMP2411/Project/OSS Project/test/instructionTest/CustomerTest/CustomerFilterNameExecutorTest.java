...
import model.instruction.customer.CustomerFilterNameExecutor;
...
public class CustomerFilterNameExecutorTest {

    @InjectMocks
    private CustomerFilterNameExecutor executor;
    ...
    public void testGetKeyword() throws SQLException {
        System.setIn(new ByteArrayInputStream("keyword".getBytes()));
        when(mockInputScanner.getInput()).thenReturn("keyword");
